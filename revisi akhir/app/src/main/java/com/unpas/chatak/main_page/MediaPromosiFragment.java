...
public class MediaPromosiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_media_promosi, container, false);
        ...
        actionBar.setTitle(getResources().getString(R.string.title_media_promosi));//set Text toolbar

        mRecyclerView = rootView.findViewById(R.id.recyclerViewMediaPromosi);
    ...
    private void mediaPromosiList(List<ApiModel> listMediaPromosi){
        adapter = new ApiAdapter(getActivity(),listMediaPromosi.subList(15,38));
